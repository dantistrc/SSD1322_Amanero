...
// Мелкий шрифт 6x8 (из u8g2_font_ncenB08_tr)
// Буквы A-Z, a-z, цифры, пробел, точка, двоеточие
// Формат: 6 байт на символ (6x8 пикселей)

const unsigned char SmallFont[][6] = {
    ...
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
    // A (0x41)
    {0x7E, 0x09, 0x09, 0x09, 0x7E, 0x00},   // <-- Вот это правильная буква А
    // B (0x42)
